...
export default function Header() {
  ...
  return (
    <>
      <header
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ease-[cubic-bezier(0.23,1,0.32,1)] border-b transition-colors duration-500 ${isOpen
      ...
      >
        <div className="max-w-[1440px] mx-auto px-6 md:px-12 h-14 md:h-16 flex items-center justify-between">
          ...
          >
            <Image
              src="/images/AIALAB-secondary-logo.webp"
              alt="AIA LAB Logo"
              width={110}
              height={32}
            ...
            {menuItems.map((item) => {
                ...
                return (
                  <div key={item.label} className="relative py-1">
                    <button
                      ...
                      className={`text-[14.5px] font-sans font-semibold px-4 py-2 rounded-full transition-all duration-300 flex items-center gap-2 outline-none focus-visible:ring-2 focus-visible:ring-secondary/50 ${isServicesOpen
                    ...
                    <div
                      style={{ width: "860px" }}
                      className={`absolute top-[140%] left-1/2 -translate-x-1/2 bg-[#0A0A0A]/90 backdrop-blur-2xl border border-white/[0.08] rounded-[2rem] shadow-[0_50px_100px_rgba(0,0,0,0.85)] p-6 transition-all duration-700 ease-[cubic-bezier(0.23,1,0.32,1)] z-50 ${isServicesOpen
              ...
              return (
                <Link
                  key={item.label}
                  href={item.href}
                  className={`text-[14.5px] font-sans font-semibold px-4 py-2 rounded-full transition-all duration-300 focus-visible:ring-2 focus-visible:ring-secondary/50 relative ${isActive
                      ? "text-black-deep"
                      : "text-black-deep/70 hover:text-black-deep hover:bg-black/5"
                    }`}
                >
          ...
          <div className="flex items-center gap-4">
            <motion.a
              ...
              className={`hidden md:inline-flex items-center justify-center font-sans font-bold tracking-tight rounded-full transition-all duration-300 active:scale-95 group relative overflow-hidden shadow-sm ${isScrolled
            ...
            <button
              ...
              className={`md:hidden z-50 p-3.5 transition-all duration-500 rounded-full flex flex-col justify-center items-center gap-1.5 w-11 h-11 relative overflow-hidden backdrop-blur-md border ${isOpen
                      ...
                      >
                        <div className="overflow-hidden flex items-center justify-between py-2 border-b border-white/[0.08]">
                          <button
                            ...
                            className={`text-3xl font-heading font-bold text-left w-full flex items-center justify-between transition-colors duration-300 ${isMobileServicesOpen ? "text-primary" : "text-white"
                              }`}
                          >
