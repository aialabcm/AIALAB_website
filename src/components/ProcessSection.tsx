      ...
      >
        ...
        >
          ...
          <div className="my-auto py-4">
            <h3 className="font-heading font-black text-2xl xs:text-3xl md:text-3xl lg:text-2xl xl:text-[28px] text-black-deep tracking-tight mb-1.5">
              {step.title}
            </h3>
        ...
        {/* BACK FACE */}
        <div
          className="absolute inset-0 w-full h-full bg-white border border-dark/5 rounded-3xl shadow-2xl p-8 flex flex-col justify-between text-black-deep"
          style={{
            backfaceVisibility: "hidden",
            WebkitBackfaceVisibility: "hidden",
        ...
        >
          {/* Back Header */}
          <div className="flex items-center justify-between w-full pb-3 border-b border-dark/5">
            <span className="font-mono text-xs font-bold text-primary tracking-widest uppercase">
              Étape {step.num}
            </span>
            <span className="font-heading font-black text-sm text-black-deep/50 tracking-wider">
              {step.title}
            </span>
          </div>
          ...
          {/* Back Description */}
          <div className="my-auto py-4">
            <p className="font-sans text-[14px] leading-relaxed text-dark/80 font-medium">
              {step.desc}
            </p>
          </div>

          {/* Back Footer */}
          <div className="flex justify-between items-center w-full pt-3 border-t border-dark/5 text-dark/40">
